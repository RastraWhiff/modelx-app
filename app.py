...
House_Ownership = st.radio("House Ownership", ["Not Both", "Owned", "Rented"])
Vehicle_Ownership_Car = st.radio("Vehicle Ownership (Car)", ["No", "Yes"])
...
# Select model
model_choice = st.radio("Pilih Model untuk Prediksi", ["XGBoost", "C4.5"])
...
if st.button("Predict"):
    new_data = np.array([[  # Your feature mappings here
    ...
    if model_choice == "XGBoost":
        ...
        result = best_c45_model.predict(new_data)
